...
def consulta():
	...
	return template('resultado.tpl',user=usuario,apagados=totalapagados,activos=totalactivos)
...
def viewinfocontainer(name):
	...
	return template('viewinfocontainer.tpl',user=usuario,info=info,file=file)
